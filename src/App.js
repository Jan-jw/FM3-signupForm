...
const App = () => {
  ...
  const validate = (e) => {
    e.preventDefault();
    let inputField = Array.from(e.target.children); 
    inputField.forEach((e) => {
      const emailPattern = /[a-z\d]+\@[a-z\d]+\.(com|net|org)$/i; 
      if (e.value === "" ||
        (e.type === "email" && !emailPattern.test(e.value))) {
        switch (e.id) {
          case "fName":
            e.placeholder = " ";
            setFname(false);
        ...
        <div className="form-fill">
          <form onSubmit={validate} noValidate>
            <input
              ...
              style={{
                border: fName ? "1px solid var(--Grayish-Blue)": "2px solid var(--Red)",
            ...
            <input
              ...
              style={{
                border: lName ? "1px solid var(--Grayish-Blue)": "2px solid var(--Red)",
            ...
            <input
              ...
              style={{
                border: email ? "1px solid var(--Grayish-Blue)" : "2px solid var(--Red)",
            ...
            <input
              ...
              style={{
                border: pWord ? "1px solid var(--Grayish-Blue)" : "2px solid var(--Red)",
